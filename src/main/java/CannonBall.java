...
//  protected PVector tempDir = new PVector(1f, -1f).normalize();
   ...
   * @param window that happens inside the window
  ...
  /**
   * This method checks which player's turn
   * Helper for outOfBounds.
   * @param window is used for making it on the window
   */
  ...
  /**
   * This method sets the relative position of the ball.
   * @param f
   */
